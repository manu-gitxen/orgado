...
import { FaUser, FaRegClock, FaArrowRight } from 'react-icons/fa'; // Ensure react-icons is installed, reusing standard icons

const NewsInsight = () => {
    const newsItems = [
        {
            id: 1,
            image: 'https://images.unsplash.com/photo-1592419044706-39796d40f98c?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', // Plant/Hands
            author: 'Orgado Admin',
        ...
        {
            id: 2,
            image: 'https://images.unsplash.com/photo-1593113598332-cd288d649433?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', // Farm girl
            author: 'John Smith',
        ...
        {
            id: 3,
            image: 'https://images.unsplash.com/photo-1625246333195-098e479720fc?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', // Farmer rice field
            author: 'Jennifer Lee',
